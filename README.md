# Npool review gateway

[![Test](https://github.com/NpoolPlatform/review-gateway/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/review-gateway/actions/workflows/main.yml)
...
* make review-gateway ```单独编译服务```
* make review-gateway-image ```单独生成服务镜像```
